...
nodes = {
    ...
    "D": m.NodeInfo(
        ...
        value=60,
        properties=["Windows_Server_2012", "E_cology_9.0", "SSH"]
    ),
    "E": m.NodeInfo(
        services=[m.ListeningService("SMB", allowedCredentials=["SMBCreds"])],
        vulnerabilities=dict(
    ...
    "H": m.NodeInfo(
        ...
        value=500,
        properties=["Windows_Server_2003", "RDP"]
    ),
    "I": m.NodeInfo(
        ...
        value=100,
        properties=["Windows_Server_2003", "SMB", "RDP"]
    )
}
